	...
	<div class="main-wrapper">
      ...
      <div class="sidebar-body">
        <ul class="nav">
			...
			<li class="nav-item">
			  <a href="{{route('indexHome')}}" class="nav-link">
...
<li class="nav-item">
	...
	<div class="collapse" id="categories">
	  <ul class="nav sub-menu">
		...
		<li class="nav-item"> <a href="{{route('subcategory')}}" class="nav-link">Sub-Category List</a></li> 
	  </ul>
	</div>
  </li>
  ...
  {{-- products menu --}}
  <li class="nav-item">
	<a class="nav-link" data-toggle="collapse" href="#pro" role="button" aria-expanded="false" aria-controls="emails">
	  <i class="link-icon" data-feather="mail"></i>
                ...
                <a href="javascript:;" class="dropdown-item py-2"><i class="flag-icon flag-icon-es" title="es" id="es"></i> <span class="ml-1"> Spanish </span></a>
						...
						<li class="nav-item dropdown nav-profile">
							<a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								...
								@else
								<img src="{{asset('uploads/user_profile_image')}}/{{Auth::user()->photo}}" alt="profile"> 
								@endif
							...
							<div class="dropdown-menu" aria-labelledby="profileDropdown">
								...
								<div class="dropdown-body">
									<ul class="profile-nav p-0 pt-3">
										...
										<li class="nav-item">
											<a href="{{route('user.selfedit')}}" class="nav-link">
